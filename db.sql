...
INSERT INTO `apartments`(`name`,`capacity`, `price_night_regular`, `price_week_regular`, `price_weekend_regular`, `price_night_season`, `price_week_season`, `price_weekend_season`,`price_night_vacation`, `price_week_vacation`, `price_weekend_vacation`) values 
('Iemke', 2, 50, 350, 100, 55, 375, 125, 70, 450, 150),
('Jaakje', 2, 50, 350, 100, 55, 375, 125, 70, 450, 150),
('Sil', 3, 60, 395, 112.5, 62, 425, 125, 72, 495, 150),
('Jelle', 4, 65, 450, 137.5, 70, 475, 162.5, 80, 550, 175),
('Wietse', 4, 65, 450, 137.5, 70, 475, 162.5, 80, 550, 175),
('Lobke', 5, 70, 475, 162.5, 75, 500, 187.5, 85, 585, 200),
('Maam', 6, 70, 475, 162.5, 75, 525, 187.5, 85, 585, 200),
('Test', 2, 10, 90, 15, 10, 90, 15, 10, 90, 15);
